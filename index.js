...
const newPlaylistBody = {
  "name": "Centurion",
  "public": true,
  "description": "One of a kind of many songs that'll make you repeat the same at least three times."
};
...
async function createPlaylist(newPlaylistBody) {
  const response = await fetch("https://open.spotify.com/user/31s5fcbgzo3pkww6ancnzov63cjm")
  const data = await response.json()
  console.log(data)
  return data
}
